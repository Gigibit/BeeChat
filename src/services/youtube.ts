...
// const dummyResp = {
//   "tracks": {
//     "href": "https://api.spotify.com/v1/search?type=track&query=mecna&type=track&market=IT&offset=0&limit=20",
//     "items": [
//       {
//         "album": {
//           "album_type": "single",
...
//   enableViewportSca : 'no', //iOS only 
//   allowInlineMediaPlayback : 'no',//iOS only 
//   presentationstyle : 'pagesheet',//iOS only 
//   fullscreen : 'yes',//Windows only    
// };

// const SPOTIFY_SERVICE_HOST ="http://192.168.1.7:8080"
...
//             });
//             this.storage.get('spotify.refresh_token').then(refresh_token=>{
//               this.refresh_token = refresh_token;
//             });
//             this.storage.get('spotify.expire_time').then(expire_time=>{
//               this.expire_time = expire_time;
//             });
//             this.storage.get('spotify.code').then(code=>{
//               this.code = code;
//             });
// }
...
// search(text, then: (tracks : Track[])=>void){
//   let tracks = []
//   this.http.get(API.search + encodeURIComponent(text.trim())+'&type=track', this.getHeaders()).subscribe(data=>{
...
//   const config = {
//     clientId: CLIENT_ID,
//     redirectUrl: CLIENT_SECRET,
//     scopes: ['app-remote-control', 'web-playback', 'user-read-playback-state', 'user-birthdate', "user-read-private", "user-read-birthdate", "user-read-email", "playlist-read-private", "user-library-read", 
//     "user-library-modify", "user-top-read", "playlist-read-collaborative", "playlist-modify-public", 
//     "playlist-modify-private", "user-follow-read", "user-follow-modify", "user-read-playback-state",
//     "user-read-currently-playing", "user-modify-playback-state", "user-read-recently-played"],
//     code: this.code,
//     tokenExchangeUrl: SPOTIFY_SERVICE_HOST+"/exchange",
//     tokenRefreshUrl:  SPOTIFY_SERVICE_HOST+"/refresh",
//   }
...
//     this.storage.set('spotify.refresh_token', data['refresh_token']);
//     this.storage.set('spotify.expire_time', data['expire_time']);
//     this.storage.set('spotify.code', this.code);
//   })
// }

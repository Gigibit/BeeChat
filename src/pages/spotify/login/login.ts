...
const CLIENT_CALLBACK_URL = 'cheepee://spoty2callback';
const SPOTIFY_AUTH_HOST = 'localhost';
...
export class LoginPage {
  ...
  authWithSpotify(showLoading = false) {
    const config = {
      ...
      tokenExchangeUrl: 'https://'+SPOTIFY_AUTH_HOST+'/exchange',
      tokenRefreshUrl: 'https://'+SPOTIFY_AUTH_HOST+'/refresh',
    };
